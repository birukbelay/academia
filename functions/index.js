...
exports.storeImage = functions.https.onRequest((req, res) => {
    return cors(req, res, () => {
        ...
        let idToken;
        // the idToken will be the one after the bearer token
        ...
        // to move incoming files to temporary storage
        ...
        busboy.on('finish', () => {
            const bucket = gcs.bucket('academia-4afa1.appspot.com');
            const id = uuid();
